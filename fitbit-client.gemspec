...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Client library which connects to the Fibit API using OAuth2}
  spec.description   = %q{Client library which connects to the Fibit API using OAuth2.}
